...
import { useAppLoader } from './AppLoader';
...
const GlobalAnnouncements = (): JSX.Element | null => {
  ...
  return (
    <>
      <div className="border-only-b-neutral-200 flex items-start space-x-4 px-5 py-3">
        <CampaignOutlined />
      ...
      {announcements.length > 1 && (
        <div className="border-only-b-neutral-200 flex items-center space-x-4 px-5 py-1">
          <CampaignOutlined />
