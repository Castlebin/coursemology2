...
export const actions = {
  fetchStudentsStatistics: (failureMessage) => {
    return (dispatch) => {
  ...
  fetchStaffStatistics: (failureMessage) => {
    return (dispatch) => {
  ...
  fetchCourseProgressionStatistics: (failureMessage) => {
    return (dispatch) => {
      dispatch({
        type: actionTypes.FETCH_COURSE_PROGRESSION_STATISTICS_REQUEST,
      });
  ...
  fetchCoursePerformanceStatistics: (failureMessage) => {
    return (dispatch) => {
      dispatch({
        type: actionTypes.FETCH_COURSE_PERFORMANCE_STATISTICS_REQUEST,
      });
